...
| <a name="input_apply_amazon_ec2_net_utils"></a> [apply\_amazon\_ec2\_net\_utils](#input\_apply\_amazon\_ec2\_net\_utils) | Enable the functionailty for Amazon EC2 Net Utils | `bool` | `true` | no |
...
| <a name="input_lb_master_access_log_bucket"></a> [lb\_master\_access\_log\_bucket](#input\_lb\_master\_access\_log\_bucket) | (Optional) The S3 bucket name to store the access logs. | `string` | `""` | no |
| <a name="input_lb_master_access_log_prefix"></a> [lb\_master\_access\_log\_prefix](#input\_lb\_master\_access\_log\_prefix) | (Optional) The S3 bucket prefix to store the access logs. | `string` | `""` | no |
| <a name="input_lb_master_connection_draining"></a> [lb\_master\_connection\_draining](#input\_lb\_master\_connection\_draining) | n/a | `bool` | `true` | no |
| <a name="input_lb_master_connection_draining_timeout"></a> [lb\_master\_connection\_draining\_timeout](#input\_lb\_master\_connection\_draining\_timeout) | n/a | `number` | `300` | no |
| <a name="input_lb_master_idle_timeout"></a> [lb\_master\_idle\_timeout](#input\_lb\_master\_idle\_timeout) | n/a | `number` | `3600` | no |
