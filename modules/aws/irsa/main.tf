...
module "ignition_pod_idenity_webhook" {
  source = "github.com/getamis/terraform-ignition-kubernetes//modules/extra-addons/aws-pod-identity-webhook?ref=feat%2Fupgrade-k8s-to-1-31-1"
...
resource "aws_iam_openid_connect_provider" "irsa" {
  url = "https://${local.odic_servername}/${var.oidc_s3_bucket}"
