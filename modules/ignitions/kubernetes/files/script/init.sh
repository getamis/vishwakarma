...
KUBELET_KUBECONFIG_SRC="${KUBE_OPT_PATH}/templates/kubelet.conf.tpl"
KUBELET_KUBECONFIG_DEST="${KUBE_ETC_PATH}/kubelet.conf"
generate::file ${KUBELET_KUBECONFIG_SRC} ${KUBELET_KUBECONFIG_DEST}

PROXY_CM_YAML_SRC="${KUBE_OPT_PATH}/templates/kube-proxy-cm.yaml.tpl"
PROXY_CM_YAML_DEST="${KUBE_ETC_PATH}/addons/kube-proxy-cm.yaml"
generate::file ${PROXY_CM_YAML_SRC} ${PROXY_CM_YAML_DEST}
